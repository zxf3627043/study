    ...
    for(int i = 0; i < img.rows; i++)
	{
        for(int j = 0; j < img.cols; j++)
        {
            ...
            */
             ...
             *      此时更新前景统计次数、更新前景模型、更新该像素模型样本值、更新该像素点邻域像素点的模型样本�?
             *------------------------------------------------------------------
             * Summary:
            ...
            */
            else
            {
                ...
                // 如果某个像素点连�?0次被检测为前景，则认为一块静止区域被误判为运动，将其更新为背景点
            ...
            //================================================================
            //        更新模型样本�?   |    Update Background Model Sample Library
            //================================================================
            if (matches >= num_min_matches)
            {
                // 已经认为该像素是背景像素，那么它�?1 / φ 的概率去更新自己的模型样本�?
